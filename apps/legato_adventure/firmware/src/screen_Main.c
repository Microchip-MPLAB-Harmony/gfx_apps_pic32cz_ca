...
static void MainScreen_HandleAnimation(uintptr_t context)
{
    ...
    if(leRenderer_IsIdle())
    {
        ...
        else if (spriteState == JUMP)
        {
            ...
            {
                spriteWidgetToPlay = Screen1_ImageSequenceWidget_JumpLeft;
            }
        }
        else if (spriteState == HURT)
        {
            if (spriteFacing == FACE_RIGHT)
            {
                spriteWidgetToPlay = Screen1_ImageSequenceWidget_HurtRight;
            }
            else
            {
                spriteWidgetToPlay = Screen1_ImageSequenceWidget_HurtLeft;
            }
        }
