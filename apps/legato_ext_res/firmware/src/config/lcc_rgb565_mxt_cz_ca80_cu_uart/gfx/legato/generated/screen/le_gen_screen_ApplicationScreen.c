...
leResult screenShow_ApplicationScreen(void)
{
    ...
    ApplicationScreen_SloganButton->fn->setPosition(ApplicationScreen_SloganButton, 10, 210);
    ApplicationScreen_SloganButton->fn->setSize(ApplicationScreen_SloganButton, 464, 50);
