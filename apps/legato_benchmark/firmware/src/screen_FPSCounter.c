...
static void resetFPS(void)
{
    ...
    FPSCounters_FPSCounterValue->fn->setString(FPSCounters_FPSCounterValue, (leString*)&fpsBtnText);
...
static void fpsUpdateTimer_Callback()
{
    ...
    if(FPSCounters_FPSCounterValue == NULL)
        return;
    ...
    if(FPSCounters_FPSUpdateValue->fn->getPressed(FPSCounters_FPSUpdateValue) == LE_FALSE)
    {
            //Update FPS
    ...
    fpsBtnText.fn->setFromCStr(&fpsBtnText, charBuff);
    FPSCounters_FPSUpdateValue->fn->setString(FPSCounters_FPSUpdateValue, (leString*)&fpsBtnText);
    ...
    FPSCounters_FPSRefreshValue->fn->setString(FPSCounters_FPSRefreshValue,
...
//    APP_DecrementCount(FPSCounters_FPSCounterValue);
}
...
static void increaseCounterSize()
{
    ...
    FPSCounters_FPSCounterValue->fn->invalidate(FPSCounters_FPSCounterValue);

    sprintf(charBuff, "%u", (unsigned int)counterStringSize);

    counterSizeStringText.fn->setFromCStr(&counterSizeStringText, charBuff);
    FPSCounters_FPSStringSize->fn->setString(FPSCounters_FPSStringSize, (leString*)&counterSizeStringText);
...
static void decrementCount()
{
    ...
    FPSCounters_FPSCounterValue->fn->setString(FPSCounters_FPSCounterValue, (leString*)&decStr);
}
