...
static void resetFPS(void)
{
    ...
    FPSImages_ImageUpdateValue->fn->setString(FPSImages_ImageUpdateValue, (leString*)&fpsBtnText);
...
static void fpsUpdateTimer_Callback()
{
    ...
    if(FPSImages_ImageUpdateValue == NULL)
        return;
    ...
    if(FPSImages_ImageUpdateValue->fn->getPressed(FPSImages_ImageUpdateValue) == LE_FALSE)
    {
            //Update FPS
    ...
    FPSImages_ImageRefreshValue->fn->setString(FPSImages_ImageRefreshValue,
...
static void increaseImageSize()
{
    ...
    FPSImages_ImageSizeValue->fn->setString(FPSImages_ImageSizeValue, (leString*)&imgSizeText);
...
static void nextImageType()
{
    ...
    FPSImages_ImageTypeValue->fn->setString(FPSImages_ImageTypeValue, (leString*)&imageTypeStr);
...
static void nextImage()
{
    ...
    if (imgType == IMG_PNG_8888)
    {
        ...
        {
            FPSImages_ImageRenderArea->fn->setImage(FPSImages_ImageRenderArea, 
