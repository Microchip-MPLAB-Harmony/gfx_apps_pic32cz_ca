...
static void resetFPS(void)
{
    ...
    FPSMotion_MotionUpdateValue->fn->setString(FPSMotion_MotionUpdateValue, (leString*)&fpsBtnText);
...
static void fpsUpdateTimer_Callback()
{
    ...
    if(FPSMotion_MotionUpdateValue == NULL)
        return;
    ...
    if(FPSMotion_MotionUpdateValue->fn->getPressed(FPSMotion_MotionUpdateValue) == LE_FALSE)
    {
            //Update FPS
    ...
    FPSMotion_MotionRefreshValue->fn->setString(FPSMotion_MotionRefreshValue,
...
static void increaseRectSize()
{
    ...
    if (rectSize == FULLSCREEN_RECT_SIZE)
    {
        ...
        FPSMotion_MotionRectSizeValue->fn->invalidateContents(FPSMotion_MotionRectSizeValue);
        FPSMotion_MotionRectSizeValue->fn->setString(FPSMotion_MotionRectSizeValue, (leString*)&squareSizeFullScreenStr);
    }
    else
    {
        ...
        FPSMotion_MotionRectSizeValue->fn->setString(FPSMotion_MotionRectSizeValue, (leString*)&squareSizeSmallStr);
    }
...
static void addRect()
{
    ...
    FPSMotion_MotionRectCount->fn->setString(FPSMotion_MotionRectCount, (leString*)&motionRectsCountText);
...
void FPSMotion_OnShow()
{
    ...
    motionWidgets[RECT_WIDGET_0].widget = &FPSMotion_RectMotionWidget1->widget;
    motionWidgets[RECT_WIDGET_1].widget = &FPSMotion_RectMotionWidget2->widget;
    motionWidgets[RECT_WIDGET_2].widget = &FPSMotion_RectMotionWidget3->widget;
    motionWidgets[RECT_WIDGET_3].widget = &FPSMotion_RectMotionWidget4->widget;
    motionWidgets[RECT_WIDGET_4].widget = &FPSMotion_RectMotionWidget5->widget;
    motionWidgets[RECT_WIDGET_5].widget = &FPSMotion_RectMotionWidget6->widget;
    motionWidgets[RECT_WIDGET_6].widget = &FPSMotion_RectMotionWidget7->widget;
    motionWidgets[RECT_WIDGET_7].widget = &FPSMotion_RectMotionWidget8->widget;
    motionWidgets[RECT_WIDGET_8].widget = &FPSMotion_RectMotionWidget9->widget;
    motionWidgets[RECT_WIDGET_9].widget = &FPSMotion_RectMotionWidget10->widget;
