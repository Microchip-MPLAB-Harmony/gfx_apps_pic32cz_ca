...
static void setup()
{
    Splash_SplashBar->fn->setX(Splash_SplashBar, barPosX);
                
    Splash_SplashPIC32Logo->fn->setAlphaEnabled(Splash_SplashPIC32Logo, LE_TRUE);
    Splash_SplashPIC32Logo->fn->setAlphaAmount(Splash_SplashPIC32Logo, splashAlpha);

    Splash_SplashHarmonyLogo->fn->setAlphaEnabled(Splash_SplashHarmonyLogo, LE_TRUE);
    Splash_SplashHarmonyLogo->fn->setVisible(Splash_SplashHarmonyLogo, LE_TRUE);
    Splash_SplashHarmonyLogo->fn->setAlphaAmount(Splash_SplashHarmonyLogo, 255 - splashAlpha);

    Splash_SplashHarmonyLogo->fn->setVisible(Splash_SplashHarmonyLogo, LE_FALSE);
    Splash_SplashHarmonyLogo->fn->setAlphaEnabled(Splash_SplashHarmonyLogo, LE_TRUE);
    Splash_SplashHarmonyLogo->fn->setAlphaAmount(Splash_SplashHarmonyLogo, 0);
...
static void swapLogoAlpha()
{
    ...
    /*switch(appSplashData.splashAlpha)
    {
        case 20:
            ...
            Splash_SplashPIC32Logo->fn->setImage(Splash_SplashPIC32Logo, &CrossFade3);
            break;
        case 40:
            if(lastSet == 40)
                break;
            ...
            lastSet = 40;
            Splash_SplashPIC32Logo->fn->setImage(Splash_SplashPIC32Logo, &CrossFade2);
            break;
        case 60:
            if(lastSet == 60)
                break;
            ...
            lastSet = 60;
            Splash_SplashPIC32Logo->fn->setImage(Splash_SplashPIC32Logo, &CrossFade1);
            break;
        case 80:
            if(lastSet == 80)
                break;
            ...
            lastSet = 80;
            Splash_SplashPIC32Logo->fn->setImage(Splash_SplashPIC32Logo, &CrossFade0);
            break;
        default:
            break;
    }*/
    ...
    {
        Splash_SplashPIC32Logo->fn->setVisible(Splash_SplashPIC32Logo, LE_FALSE);
        Splash_SplashPIC32Logo->fn->setAlphaEnabled(Splash_SplashPIC32Logo, LE_FALSE);

        Splash_SplashHarmonyLogo->fn->setAlphaEnabled(Splash_SplashHarmonyLogo, LE_FALSE);
